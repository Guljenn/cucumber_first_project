...
formatter.feature({
  "name": "Carvana CAR FINDER Functionality",
  "description": "",
  "keyword": "Feature",
  "tags": [
    {
...
formatter.match({
  "location": "CarvanaSteps.userShouldSeeErrorText(String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "CarvanaSteps.userClicksOnMenuItemLink(String)"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "user clicks on \"Cost of Car I want\" and enters \"10,000\"",
  "keyword": "When "
});
formatter.match({
  "location": "CarvanaSteps.userClicksOnAndEnters(String,String)"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "user clicks on \"What\u0027s Your Credit Score?\" and selects \"Excellent: 780\"",
  "keyword": "And "
});
formatter.match({
  "location": "CarvanaSteps.userClicksOnAndSelects(String,String)"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "user clicks on \"Choose Your Loan Term\" and select \"60 Months\"",
  "keyword": "And "
});
formatter.match({
  "location": "CarvanaSteps.userClicksOnAndSelect(String,String)"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "user clicks on \"What is Your Down Payment?\" and enters \"1,500\"",
  "keyword": "And "
});
formatter.match({
  "location": "CarvanaSteps.userClicksOnAndEnters(String,String)"
